...
public class ChiTietHoaDonDV extends JDialog {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Thông Tin Hóa Đơn", JLabel.CENTER);
        ...
        // Row 3: Mã NV
        addInvoiceInfoRow(infoPanel, "Mã NV Lập:", 2, gbc);
        sidValueLabel = addValueLabel(infoPanel, "", 2, gbc);
        
        // Row 4: Tên NV
        addInvoiceInfoRow(infoPanel, "Tên NV Lập:", 3, gbc);
        snameValueLabel = addValueLabel(infoPanel, "", 3, gbc);
        
        // Row 5: Khuyến mãi
        addInvoiceInfoRow(infoPanel, "Khuyến Mãi:", 4, gbc);
        kmValueLabel = addValueLabel(infoPanel, "", 4, gbc);
        ...
        // Tổng tiền
        addSummaryRow(summaryPanel, "Tổng Tiền:", 0, gbcSum);
        totalValueLabel = addSummaryValue(summaryPanel, "", 0, gbcSum);
        
        // Giá được giảm
        addSummaryRow(summaryPanel, "Giá Được Giảm:", 1, gbcSum);
    ...
    private void loadChiTietHoaDon() {
        try {
            System.out.println("Bắt đầu tải chi tiết hóa đơn: " + maHD);
            ...
            dateValueLabel.setText(hoaDon.getNgayLap() != null ? 
                    new SimpleDateFormat("dd/MM/yyyy h:mm:ss a").format(hoaDon.getNgayLap()) : "");
            sidValueLabel.setText(nv != null ? String.valueOf(nv.getMaNV()) : "X");
            kmValueLabel.setText(hoaDon.getMaKM() == null || hoaDon.getMaKM().isEmpty() ? "Không có" : hoaDon.getMaKM());
            snameValueLabel.setText(nv != null ? nv.getHoTen() : "X");
            
            // Xử lý thông tin tài chính
            int tienGiam = hoaDon.getTienDuocGiam() != null ? hoaDon.getTienDuocGiam() : 0;
            int tongTien = hoaDon.getTongThanhToan() != null ? hoaDon.getTongThanhToan() : 0;
